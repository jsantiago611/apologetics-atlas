...
export const siteName = 'Zettelkasten Stuff';
...
export const author = {
  name: 'Jonathan D', // i.e. Lene Saile - page / blog author's name. Must be set.
...
export const creator = {
  name: 'Jonathan D', // i.e. Lene Saile - creator's (developer) name.
